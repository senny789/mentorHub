...
time();
  ...
  return (
    <div className="data z-10 p-8 flex rounded-lg absolute md: translate-x-16 bg-white">
      ...
      <div>
        <h2  className="hover:opacity-50 cursor-pointer" onClick={()=>setCelcius(!celcius)}>Weather/Temp <span>{celcius?'C':'K'} &deg;</span></h2>
        ...
        <h1>{celcius? (Math.floor(data.main.temp- 273.15))+" C":data.main.temp+"K"}&deg;</h1>
